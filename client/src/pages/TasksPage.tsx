...
const TasksPage = () => {
  ...
  return (
    <div className='animate-in fade-in slide-in-from-bottom-4 duration-500 relative'>
      ...
      {error && (
        <div className='mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/50 rounded-xl flex items-start gap-3 text-red-700 dark:text-red-400'>
          <svg
      ...
      <div className='flex flex-col md:flex-row gap-3 mb-6 bg-white dark:bg-black p-2 rounded-xl border border-slate-200 dark:border-neutral-800 shadow-sm'>
        ...
        <button
          ...
          className='hidden md:flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all whitespace-nowrap bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 disabled:opacity-50 disabled:cursor-not-allowed'
      ...
      {editingTask && (
        <div className='fixed inset-0 bg-slate-800/20 dark:bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4'>
          <div className='bg-white dark:bg-[#0a0a0a] rounded-xl shadow-xl border dark:border-neutral-800 max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-4 border-b border-slate-100 dark:border-neutral-800 flex justify-between items-center sticky top-0 bg-white dark:bg-[#0a0a0a] z-10'>
              <h3 className='font-bold text-slate-800 dark:text-slate-100'>Edit Task</h3>
              <button
                onClick={() => setEditingTask(null)}
                className='text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 bg-slate-100 dark:bg-neutral-800 hover:bg-slate-200 dark:hover:bg-neutral-700 rounded-lg p-1.5 transition-colors'
              >
                <svg
                  width='20'
                  height='20'
